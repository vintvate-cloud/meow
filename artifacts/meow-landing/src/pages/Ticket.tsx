...
PRODID:-//MEOW//EN
BEGIN:VEVENT
UID:${eventId}@meow.events
DTSTAMP:${formatICSDate(new Date())}
DTSTART:${formatICSDate(startDate)}
DTEND:${formatICSDate(endDate)}
SUMMARY:${event.title}
LOCATION:${event.location}
DESCRIPTION:Your RSVP ticket is confirmed.
END:VEVENT
END:VCALENDAR`;
    ...
    toast({
      ...
      description: "Open the file to instantly add this event to your Apple or Google Calendar.",
    });
  };
      ...
      >
        ...
        <div className="p-10 pt-16 space-y-8">
          ...
          <div className="flex flex-col gap-3">
            <Button onClick={handleAddToCalendar} className="w-full h-14 rounded-2xl font-bold text-[15px] shadow-md bg-black text-white hover:bg-gray-900 border-none flex items-center justify-center gap-2 transition-transform hover:scale-[1.02]">
            ...
            <Button onClick={handleAddToCalendar} className="w-full h-14 rounded-2xl font-bold text-[15px] shadow-md bg-white text-gray-900 hover:bg-gray-50 border border-gray-200 flex items-center justify-center gap-2 transition-transform hover:scale-[1.02]">
