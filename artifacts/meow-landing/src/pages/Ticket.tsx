...
export default function Ticket() {
  ...
  return (
    <div className="min-h-screen bg-[#F3F0E8] p-6 md:p-12 flex flex-col items-center justify-center font-sans">
      <motion.div
        initial={{ y: 20, opacity: 0 }}
        animate={{ y: 0, opacity: 1 }}
        className="w-full max-w-md bg-white rounded-[48px] shadow-2xl overflow-hidden border-8 border-white"
      >
        {/* Header Color Strip */}
        ...
        <div className="p-10 pt-16 space-y-8">
          ...
          <div className="bg-[#F3F0E8] p-8 rounded-[40px] flex flex-col items-center space-y-6">
        ...
        {/* Ticket Notch Effect */}
        <div className="relative h-10 bg-white border-t-4 border-dashed border-gray-100">
          <div className="absolute -left-5 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-[#F3F0E8]"></div>
          <div className="absolute -right-5 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-[#F3F0E8]"></div>
        </div>
